...
//!
//! Renders the polar plot at scale 1.05 — the OutBack overshoot
//! peak — so the still-frame fallback communicates "this chart
//! is mid-scale, just past the overshoot point of an OutBack
//! ease".
...
const W: u32 = 360;
const H: u32 = 360;
const OVERSHOOT_SCALE: f32 = 1.05;

#[test]
fn polar_tween_hero_renders_to_snapshot() {
    ...
    graphics.container.transform = Transform::from_scale(Vec2::splat(OVERSHOOT_SCALE));

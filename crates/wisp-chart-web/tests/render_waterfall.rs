...
use wisp_chart_web::fixtures::waterfall_fixture;

const W: u32 = 480;
const H: u32 = 240;

#[test]
fn waterfall_renders_to_snapshot() {
    ...
    let w = waterfall_fixture();
    let graphics = w.emit_graphics(&theme, viewport);

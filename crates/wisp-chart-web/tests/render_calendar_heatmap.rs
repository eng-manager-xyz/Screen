...
//! Calendar heatmap (year-in-review) snapshot.
...
#![allow(
    ...
    reason = "viewport bounded by W=720, H=120"
)]
...
use wisp_chart_web::fixtures::calendar_heatmap_fixture;

const W: u32 = 720;
const H: u32 = 120;

#[test]
fn calendar_heatmap_renders_to_snapshot() {
    ...
    let cal = calendar_heatmap_fixture();
    let graphics = cal.emit_graphics(&theme, viewport);

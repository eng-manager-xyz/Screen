//! Sunburst snapshot — radial hierarchy.
...
use wisp_chart_web::fixtures::sunburst_fixture;

const W: u32 = 320;
const H: u32 = 320;

#[test]
fn sunburst_renders_to_snapshot() {

...
use wisp_chart_web::fixtures::baseline_fixture;

const W: u32 = 480;
const H: u32 = 240;

#[test]
fn baseline_renders_to_snapshot() {
    ...
    let b = baseline_fixture();
    let graphics = b.emit_graphics(&theme, viewport);

...
use wisp_chart_web::fixtures::boxplot_fixture;

const W: u32 = 400;
const H: u32 = 240;

#[test]
fn boxplot_renders_to_snapshot() {
    ...
    let bp = boxplot_fixture();
    let graphics = bp.emit_graphics(&theme, viewport);

...
#![allow(
    ...
    reason = "viewport bounded by W=600, H=200"
)]
...
use wisp_chart_web::fixtures::lasagna_fixture;

const W: u32 = 600;
const H: u32 = 200;

#[test]
fn lasagna_renders_to_snapshot() {
    ...
    let l = lasagna_fixture();
    let graphics = l.emit_graphics(&theme, viewport);

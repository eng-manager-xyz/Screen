...
#![allow(
    ...
    reason = "viewport bounded by W=480, H=280"
)]
...
use wisp_chart_web::fixtures::parallel_coords_fixture;

const W: u32 = 480;
const H: u32 = 280;

#[test]
fn parallel_coords_renders_to_snapshot() {
    ...
    let pc = parallel_coords_fixture();
    let graphics = pc.emit_graphics(&theme, viewport);

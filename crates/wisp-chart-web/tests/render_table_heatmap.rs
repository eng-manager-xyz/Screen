...
#![allow(
    ...
    reason = "viewport bounded by W=400, H=240"
)]
...
use wisp_chart_web::fixtures::table_heatmap_fixture;

const W: u32 = 400;
const H: u32 = 240;

#[test]
fn table_heatmap_renders_to_snapshot() {
    ...
    let h = table_heatmap_fixture();
    let graphics = h.emit_graphics(&theme, viewport);

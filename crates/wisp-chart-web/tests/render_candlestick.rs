...
use wisp_chart_web::fixtures::candlestick_fixture;

const W: u32 = 480;
const H: u32 = 240;

#[test]
fn candlestick_renders_to_snapshot() {
    ...
    let c = candlestick_fixture();
    let graphics = c.emit_graphics(&theme, viewport);

...
Color is per-Text. To recolor mid-string would require multiple Text nodes — fine for the recorder (keyboard chips, captions) where we never mix colors mid-glyph.
